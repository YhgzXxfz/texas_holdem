...
class PreflopRoundTest(unittest.TestCase):
    ...
    def test_initialize_preflop(self):
        ...
        self.assertTrue({self.game.deck.cards[0], self.game.deck.cards[4]}, set(self.phil.hands))
        self.assertTrue({self.game.deck.cards[1], self.game.deck.cards[5]}, set(self.harry.hands))
        self.assertTrue({self.game.deck.cards[2], self.game.deck.cards[6]}, set(self.tom.hands))
        self.assertTrue({self.game.deck.cards[3], self.game.deck.cards[7]}, set(self.anton.hands))
        ...
        self.assertTrue(self.preflop.check_round_result() == [])
    ...
    def test_preflop_result_when_all_players_but_one_fold(self):
        ...
        self.assertTrue(self.anton.money == 1_000)
        self.assertFalse(self.game.pot.is_balanced(RoundName.PREFLOP))
        self.assertTrue(self.preflop.check_round_result() == [self.harry])
    ...
    def test_preflop_pot_is_not_finished_before_big_blind_takes_action(self):
        ...
        self.assertTrue(self.preflop.check_round_result() == [], "round is not finished.")
    ...
    def test_preflop_pot_is_terminated_when_everyone_calls_and_big_blind_checks(self):
        ...
        self.assertTrue(self.anton.money == 1_000)
        self.assertTrue(self.game.pot.is_balanced(RoundName.PREFLOP))
        self.assertTrue(self.preflop.check_round_result() == [self.phil, self.harry])
